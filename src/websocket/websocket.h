...
struct MessageHeader {
  ...
  size_t GetByteLength() const {
    const size_t len = 15 * 4 + 16 + // first number is equal to number of entries in header before map (each 4 bytes)
